            ...
            { "data": "nombre", "autoWidth": true },            
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                                <a href="/Admin/SubCategorias/Edit/${data}" class="btn btn-success text-white" style="cursor:pointer; width:140px;">
                                <i class="far fa-edit"></i> Editar
                                </a>
                                &nbsp;
                                <a onclick=Delete("/Admin/SubCategorias/Delete/${data}") class="btn btn-danger text-white" style="cursor:pointer; width:140px;">
